...
const CarPoolIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M36 18H12L8 30H40L36 18Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14 36H10V33H38V36H34" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="16" cy="30" r="3" stroke="currentColor" strokeWidth="2" />
    <circle cx="32" cy="30" r="3" stroke="currentColor" strokeWidth="2" />
    <path d="M24 18V12H32L36 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
const SaveMoneyIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 12C14.1 12 6 18.6 6 24C6 29.4 14.1 36 24 36C33.9 36 42 29.4 42 24C42 18.6 33.9 12 24 12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M24 30C26.7614 30 29 27.3137 29 24C29 20.6863 26.7614 18 24 18C21.2386 18 19 20.6863 19 24C19 27.3137 21.2386 30 24 30Z" stroke="currentColor" strokeWidth="2" />
    <path d="M24 18V30" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <path d="M32 14L16 34" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
const RideOptionsIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="12" y="18" width="24" height="12" rx="6" stroke="currentColor" strokeWidth="2" />
    <circle cx="18" cy="24" r="3" stroke="currentColor" strokeWidth="2" />
    <circle cx="30" cy="24" r="3" stroke="currentColor" strokeWidth="2" />
    <path d="M9 16C6.5 18.5 6 22.5 6 24C6 25.5 6.5 29.5 9 32" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M39 16C41.5 18.5 42 22.5 42 24C42 25.5 41.5 29.5 39 32" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

const LiveTrackingIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 6L24 42" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeDasharray="2 4" />
    <path d="M12 12H36" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeDasharray="2 4" />
    <path d="M12 36H36" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeDasharray="2 4" />
    <path d="M30 18C30 16.3431 32.6863 15 36 15C39.3137 15 42 16.3431 42 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <rect x="30" y="18" width="12" height="6" rx="3" stroke="currentColor" strokeWidth="2" />
    <circle cx="36" cy="30" r="6" stroke="currentColor" strokeWidth="2" />
    <circle cx="36" cy="30" r="2" stroke="currentColor" strokeWidth="2" />
    <path d="M16 24L10 30L16 36" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export default function Features() {
  const features = [
    {
      ...
      description: "Travel safely with verified students from your college community.",
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white via-white to-[#f7f9fa] relative overflow-hidden">
      ...
      <div className="absolute w-full h-1 bottom-3 left-0 right-0 bg-[#f3d062]" style={{ backgroundImage: 'linear-gradient(90deg, #f3d062 50%, transparent 50%)', backgroundSize: '20px 100%' }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#4A5D58]/80 max-w-2xl mx-auto">
            CoRide connects college students for affordable, convenient, and eco-friendly transportation tailored to campus life
          </p>
        </motion.div>
        ...
        <div className="relative h-6 mb-12 overflow-hidden">
          ...
          <div className="absolute w-full h-1 top-3 bg-[#f3d062]" style={{ backgroundImage: 'linear-gradient(90deg, #f3d062 50%, transparent 50%)', backgroundSize: '20px 100%' }}></div>
        </div>
        ...
        >
          {features.map((feature, index) => (
            <motion.div 
              ...
              style={{ borderColor: `var(--${feature.color.split(' ')[1].replace('text-', '')})` }}
            ...
            >
              ...
              {/* Feature Content */}
              <h3 className="text-xl font-bold mb-2 text-[#4A5D58]">{feature.title}</h3>
        ...
        <div className="relative h-40 my-12">
          <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 1200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,200 L0,100 L100,100 L100,50 L150,50 L150,100 L200,100 L200,150 L250,150 L250,70 L300,70 L300,150 L350,150 L350,120 L400,120 L400,80 L450,80 L450,120 L500,120 L500,150 L550,150 L550,100 L600,100 L600,50 L650,50 L650,100 L700,100 L700,150 L800,150 L800,70 L850,70 L850,100 L900,100 L900,50 L950,50 L950,100 L1000,100 L1000,150 L1050,150 L1050,120 L1100,120 L1100,80 L1150,80 L1150,100 L1200,100 L1200,200 Z" fill="#e0e5e8" />
            <path d="M550,100 L550,50 L570,30 L590,50 L590,100 Z" fill="#4A5D58" />
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-2xl font-bold text-center mb-8 text-[#4A5D58]">Why College Students Love CoRide</h3>
